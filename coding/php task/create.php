    ...
    <div class="container mt-5">
    	...
    	<form action="libs/action.php" method="post" id="createform" name="createform" onsubmit="return setValidationResponse()">
    		<div class="row">
	    		<div class="col-md-6">
	    			<div class="form-group">
					    ...
					    <input type="text" class="form-control" placeholder="Enter Name" name="name" id="name" <?php if (isset($_SESSION['name'])): ?>
					    	value = <?=$_SESSION['name']?>
					    <?php endif ?>>
	    		...
	    		<div class="col-md-6">
	    			<div class="form-group">
					    ...
					    <input type="text" class="form-control" placeholder="Enter Email" name="email" id="email" <?php if (isset($_SESSION['email'])): ?>
    		...
    		<div class="row">
	    		<div class="col-md-6">
	    			<div class="form-group">
					    ...
					    <input type="text" class="form-control" placeholder="Enter Phone" name="phone" id="phone" <?php if (isset($_SESSION['phone'])): ?>
	    		...
	    		<div class="col-md-6">
	    			<div class="form-group">
					    ...
					    <input type="text" class="form-control" placeholder="Enter Title" name="title" id="title" <?php if (isset($_SESSION['title'])): ?>
    		...
    		<div class="row">
	    		<div class="col-md-6">
	    			<div class="form-group">
					    ...
					    <input type="datetime-local" class="form-control" placeholder="Enter Title" name="datetime" id="datetime" <?php if (isset($_SESSION['datetime'])): ?>
					    	value = <?=$_SESSION['datetime']?>
					    <?php endif ?>>
    		...
    		<div class="row">
	    		<div class="col-md-12">
	    			<div class="form-group">
					    <button type="submit" name="create" id="create" class="btn px-5 btn-success">Create</button>
					 </div>
	    		</div>	
    		</div>
    	</form>

...
<body>
    ...
    <div class="container mt-5">
    	...
    	<form action="index.php" method="post" id="createform" name="createform" onsubmit="return setValidationResponse()">
    		<div class="row">
	    		<div class="col-md-6">
    		...
    		<div class="row">
	    		<div class="col-md-6">
	    			<div class="form-group">
					    ...
					    <span id="datetime-error" class="error"></span>
					 </div>
	    		</div>	
    		</div>
    		<div class="row">
	    		<div class="col-md-12">
	    			<div class="form-group">
					    <button type="submit" class="btn px-5 btn-success">Update</button>
					 </div>
	    		</div>
